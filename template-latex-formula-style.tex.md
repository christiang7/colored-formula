# template-latex-formula-style.tex
Created 2026-04-14
...
*make.sh*
```bash
noweb.py -Rtemplate-latex-formula-style.tex template-latex-formula-style.tex.md > template-latex-formula-style.tex && notify-send -a "Compilation of template-latex-formula-style.tex" "" "$(date +"%Y-%m-%d") fertig"
```
