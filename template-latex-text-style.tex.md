...
*make.sh*
```bash
noweb.py -Rtemplate-latex-text-style.tex template-latex-text-style.tex.md > template-latex-text-style.tex && notify-send -a "Compilation of template-latex-text-style.tex" "" "$(date +"%Y-%m-%d") fertig" 
```
