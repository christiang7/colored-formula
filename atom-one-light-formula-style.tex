...
\definecolor{color-important}{HTML}{ null }

\definecolor{color-function-operator}{HTML}{ null }

\definecolor{color-operator}{HTML}{ null }

\definecolor{color-general-variable}{HTML}{ null }

\definecolor{color-index}{HTML}{ b30000 }

\definecolor{color-parameter}{HTML}{ null }

\definecolor{color-stochastic}{HTML}{ null }

\definecolor{color-data}{HTML}{ null }
